...
import com.mobilesoftphone4.ui.calllog.CallLogAdapter.OnCallLogAction;
 ...
 */
@SuppressLint("NewApi") public class CallLogListFragment extends CSSListFragment implements ViewPagerVisibilityListener,
    ...
    public void onVisibilityChanged(boolean visible) {
        ...
        if(visible) {
            Log.e(THIS_FILE,"VISIBILITY CHECK");
            attachAdapter();
            // Start loading
            if(!alreadyLoaded) {
