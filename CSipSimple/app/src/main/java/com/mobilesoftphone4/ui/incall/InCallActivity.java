...
import com.mobilesoftphone4.ui.PickupSipUri;
import com.mobilesoftphone4.ui.incall.CallProximityManager.ProximityDirector;
import com.mobilesoftphone4.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.mobilesoftphone4.ui.incall.locker.IOnLeftRightChoice;
import com.mobilesoftphone4.ui.incall.locker.InCallAnswerControls;
import com.mobilesoftphone4.ui.incall.locker.ScreenLocker;
import com.mobilesoftphone4.utils.CallsUtils;
...
import com.mobilesoftphone4.utils.keyguard.KeyguardWrapper;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "com.mobilesoftphone4.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.mobilesoftphone4.videoCall");
