...
package com.mobilesoftphone4.wizards.utils;
    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.mobilesoftphone4.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.mobilesoftphone4.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
