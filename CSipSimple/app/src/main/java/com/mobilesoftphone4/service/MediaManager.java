...
import com.mobilesoftphone4.utils.Ringer;
import com.mobilesoftphone4.utils.accessibility.AccessibilityWrapper;
import com.mobilesoftphone4.utils.audio.AudioFocusWrapper;
import com.mobilesoftphone4.utils.bluetooth.BluetoothWrapper;
import com.mobilesoftphone4.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		*/
		...
		if(wifiLock == null) {
			wifiLock = wman.createWifiLock( 
							...
							"com.mobilesoftphone4.InCallLock");
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.mobilesoftphone4.onIncomingCall.SCREEN");
