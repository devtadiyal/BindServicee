...
package com.mobilesoftphone4.service;
...
import com.mobilesoftphone4.api.ISipConfiguration;
...
import com.mobilesoftphone4.api.SipMessage;
...
import com.mobilesoftphone4.pjsip.PjSipCalls;
import com.mobilesoftphone4.pjsip.PjSipService;
import com.mobilesoftphone4.pjsip.UAStateReceiver;
import com.mobilesoftphone4.service.receiver.DynamicReceiver4;
import com.mobilesoftphone4.service.receiver.DynamicReceiver5;
import com.mobilesoftphone4.ui.incall.InCallMediaControl;
import com.mobilesoftphone4.utils.Compatibility;
import com.mobilesoftphone4.utils.CustomDistribution;
import com.mobilesoftphone4.utils.ExtraPlugins;
import com.mobilesoftphone4.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.mobilesoftphone4.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.mobilesoftphone4.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.mobilesoftphone4.SipService");
