...
package com.mobilesoftphone4.utils.backup;
	...
	public static BackupWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(8)) {
                instance = new com.mobilesoftphone4.utils.backup.BackupUtils8();
			}else {
                instance = new com.mobilesoftphone4.utils.backup.BackupUtils3();
			}
		    if(instance != null) {
