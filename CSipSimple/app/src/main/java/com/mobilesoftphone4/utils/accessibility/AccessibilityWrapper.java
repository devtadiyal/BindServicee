...
package com.mobilesoftphone4.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.mobilesoftphone4.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.mobilesoftphone4.utils.accessibility.Accessibility3();
			}
		}
