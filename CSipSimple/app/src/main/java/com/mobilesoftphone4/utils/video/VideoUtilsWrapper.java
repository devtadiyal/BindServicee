...
package com.mobilesoftphone4.utils.video;
    ...
    public static VideoUtilsWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(5)) {
                instance = new com.mobilesoftphone4.utils.video.VideoUtils5();
            } else {
                instance = new com.mobilesoftphone4.utils.video.VideoUtils3();
            }
        }
