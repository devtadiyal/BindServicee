...
package com.mobilesoftphone4.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.mobilesoftphone4.widgets.contactbadge.QuickContactBadge topBadge) {
