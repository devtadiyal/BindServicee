...
package com.mobilesoftphone4.pjsip.earlylock;
...
import com.mobilesoftphone4.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.mobilesoftphone4.earlylock");
            wl.acquire();
        }
