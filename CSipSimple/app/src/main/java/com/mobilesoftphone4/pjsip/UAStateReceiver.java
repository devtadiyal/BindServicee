...
import com.mobilesoftphone4.api.SipCallSession.StatusCode;
...
import com.mobilesoftphone4.service.SipNotifications;
...
import com.mobilesoftphone4.service.impl.SipCallSessionImpl;
import com.mobilesoftphone4.utils.CallLogHelper;
import com.mobilesoftphone4.utils.Compatibility;
import com.mobilesoftphone4.utils.Log;
import com.mobilesoftphone4.utils.Threading;
    ...
    public void initService(PjSipService srv) {
        ...
        if (eventLock == null) {
            ...
            eventLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                    "com.mobilesoftphone4.inEventLock");
        ...
        if (ongoingCallLock == null) {
            ...
            ongoingCallLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                    "com.mobilesoftphone4.ongoingCallLock");
